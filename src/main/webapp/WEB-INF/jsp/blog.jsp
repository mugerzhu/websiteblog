...
<html>
	...
	<div class="container-wrap">
		...
		<div id="fh5co-blog">
			<div class="row">
				<c:forEach var="titleandidanddate" items="${indexObject}">
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<div class="blog-text">
							<h3><a href="/blog/${titleandidanddate.id}">${titleandidanddate.title}</a></h3>
							<span class="posted_on">${titleandidanddate.date}</span>
							<ul class="stuff">
								<li><i class="icon-heart3"></i>249</li>
								<li><i class="icon-eye2"></i>1,308</li>
								<li><a href="/blog/${titleandidanddate.id}">Read More<i class="icon-arrow-right22"></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
